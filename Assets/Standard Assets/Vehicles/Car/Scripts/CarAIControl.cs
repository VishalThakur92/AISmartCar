...
namespace UnityStandardAssets.Vehicles.Car
{
    ...
    public class CarAIControl : MonoBehaviour
    {
		...
		[SerializeField] private bool m_StopWhenTargetReached = true;                                    // should we stop driving when we reach the target?
...
//					Debug.LogError ("velocity is being Set" + fwd);
				} 
//				else
//					Debug.LogError ("velocity is not being Set");
...
//				Debug.LogError ("steer" + steer + "\taccel" + accel + "\taccel" + accel);
